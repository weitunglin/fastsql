...
python -u text2sql.py \
    ...
    --epochs 5 \
    --seed 42 \
    --save_path "./models/text2natsql-t5-base-car" \
    --tensorboard_save_path "./tensorboard_log/text2natsql-t5-base-car" \
...
python -u evaluate_text2sql_ckpts.py \
    ...
    --seed 42 \
    --save_path "./models/text2natsql-t5-base-car" \
    --eval_results_path "./eval_results/car-text2natsql-t5-base" \
    --mode eval \
